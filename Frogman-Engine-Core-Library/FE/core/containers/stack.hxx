...
protected:
	...
	pointer m_front_ptr;
	pointer const m_end_ptrc;

	_FORCE_INLINE_ stack_base() noexcept : m_memory(), m_front_ptr(reinterpret_cast<pointer>(m_memory)), m_end_ptrc(m_front_ptr) {}
...
public:
	...
	{
		return (this->m_front_ptr == this->m_end_ptrc) ? true : false;
	}

	_FORCE_INLINE_ length_type length() noexcept
	{
		return this->m_front_ptr - this->m_end_ptrc;
	}
...
protected:
	...
	{
		this->m_front_ptr = this->m_end_ptrc;
	}
};
...
public:
	...
	_FORCE_INLINE_ stack(stack& other_ref_p) noexcept : base_type()
	{
		...
		this->__jump_top_pointer(other_ref_p.m_front_ptr - other_ref_p.m_end_ptrc);
	...
	_FORCE_INLINE_ stack(stack&& rvalue_p) noexcept : base_type()
	{
		...
		this->__jump_top_pointer(rvalue_p.m_front_ptr - rvalue_p.m_end_ptrc);
	...
	{
		FE_EXIT(this->m_front_ptr >= this->m_end_ptrc + max_element_count, "UNRECOVERABLE ERROR!: The stack top exceeded the index boundary of the underlying container", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_OUT_OF_RANGE);

		*this->m_front_ptr = value_p;
		++this->m_front_ptr;
	}

	_FORCE_INLINE_ value_type pop() noexcept
	{
		FE_EXIT(this->is_empty() == true, "UNRECOVERABLE ERROR!: The stack top index reached zero. The index value_p must be greater than zero", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_OUT_OF_RANGE);
	...
	_FORCE_INLINE_ void pop_all() noexcept
	{
		...
		FE::memset_s(this->m_end_ptrc, _NULL_, max_element_count, sizeof(T));
	}
};
...
public:
	...
	_FORCE_INLINE_ ~stack() noexcept
	{
		...
		FE::destruct<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, this->m_end_ptrc + FE::bool_mask_length<OBJECT_LIFECYCLE>(this->m_bool_mask, max_element_count), this->m_bool_mask);
	}
	...
	_FORCE_INLINE_ stack(std::initializer_list<value_type>&& initializer_list_p) noexcept : base_type(), m_bool_mask()
	{
		...
		FE::move_construct<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, initializer_list_p.size(), this->m_bool_mask,
	...
	_FORCE_INLINE_ stack(stack& other_ref_p) noexcept : base_type(), m_bool_mask()
	{
		...
		FE::copy_construct<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, max_element_count, static_cast<OBJECT_LIFECYCLE*>(this->m_bool_mask),
																				other_ref_p.m_end_ptrc, l_other_bool_mask_length, static_cast<const OBJECT_LIFECYCLE*>(other_ref_p.m_bool_mask));
	...
	_FORCE_INLINE_ stack(stack&& rvalue_p) noexcept : base_type(), m_bool_mask()
	{
		...
		FE::move_construct<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, max_element_count, static_cast<OBJECT_LIFECYCLE*>(this->m_bool_mask),
																				rvalue_p.m_end_ptrc, l_rvalue_bool_mask_length, static_cast<OBJECT_LIFECYCLE*>(rvalue_p.m_bool_mask));
	
		FE::destruct<FE::iterator<FE::contiguous_iterator<value_type>>>(rvalue_p.m_end_ptrc, rvalue_p.m_end_ptrc + (rvalue_p.m_front_ptr - rvalue_p.m_end_ptrc), rvalue_p.m_bool_mask);
	...
	_FORCE_INLINE_ stack& operator=(std::initializer_list<value_type> initializer_list_p) noexcept
	{
		...
		FE::move_assign<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, initializer_list_p.size(), this->m_bool_mask,
																				const_cast<T*>(initializer_list_p.begin()), initializer_list_p.size());
		this->__jump_top_pointer(initializer_list_p.size());
		return *this;
	}
	...
	_FORCE_INLINE_ stack& operator=(stack& other_ref_p) noexcept
	{
		...
		FE::copy_assign<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, max_element_count, static_cast<OBJECT_LIFECYCLE*>(this->m_bool_mask),
																				other_ref_p.m_end_ptrc, l_other_bool_mask_length, static_cast<const OBJECT_LIFECYCLE*>(other_ref_p.m_bool_mask));
		this->__jump_top_pointer(l_other_bool_mask_length);
		other_ref_p.__set_top_pointer_to_zero();
		return *this;
	...
	_FORCE_INLINE_ stack& operator=(stack&& rvalue_p) noexcept
	{
		...
		FE::move_assign<FE::iterator<FE::contiguous_iterator<value_type>>>(this->m_end_ptrc, max_element_count, static_cast<OBJECT_LIFECYCLE*>(this->m_bool_mask),
																				rvalue_p.m_end_ptrc, l_rvalue_bool_mask_length, static_cast<OBJECT_LIFECYCLE*>(rvalue_p.m_bool_mask));
	...
	_FORCE_INLINE_ void push(value_type value_p) noexcept
	{
		...
		FE::move_assign(this->m_front_ptr, this->m_bool_mask[this->m_front_ptr - this->m_end_ptrc], std::move(value_p));
		++this->m_front_ptr;
	}
	...
	_FORCE_INLINE_ value_type pop() noexcept
	{
		...
		--this->m_front_ptr;
		T l_return_value_buffer = *this->m_front_ptr;
		FE::destruct(this->m_front_ptr, this->m_bool_mask[this->m_front_ptr - this->m_end_ptrc]);
		return l_return_value_buffer;
	}
	...
	_FORCE_INLINE_ void pop_all() noexcept
	{
		...
		this->__set_top_pointer_to_zero();
		FE::destruct(this->m_end_ptrc, this->m_end_ptrc + (this->m_front_ptr - this->m_end_ptrc), this->m_bool_mask);
	}
};
