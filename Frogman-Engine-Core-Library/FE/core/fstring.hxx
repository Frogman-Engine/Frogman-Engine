...
public:
    ...
    {
        FE_ASSERT(position_p >= string_max_capacity, "ERROR: position_p cannot be greater than the string capacity.");
        FE_EXIT(str_ptrc_p == nullptr, "ERROR: the input string is nullptr", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR);
    ...
    {
        return (algorithm::string::search_very_first_substring(this->m_fstring, substring_ref_p.data())).has_value();
    }
    _FORCE_INLINE_ constexpr var::boolean contains(const char_type target_character_p) const noexcept
    {
        algorithm::string::char_search_result<char_type> l_target_char_search_result = algorithm::string::search_very_first_char(this->m_fstring, target_character_p);
    ...
    _FORCE_INLINE_ constexpr var::boolean contains(const char_type* const target_substring_ptrc_p) const noexcept
    {
        ...
        return (algorithm::string::search_very_first_substring(this->m_fstring, target_substring_ptrc_p)).has_value();
    }
    ...
    _FORCE_INLINE_ constexpr FE::optional<algorithm::string::range> find(fixed_sized_string& target_substring_ref_p, size_type position_p = 0) const noexcept
    {
        ...
        FE::optional<algorithm::string::range> l_result = algorithm::string::search_very_first_substring(this->m_fstring + position_p, target_substring_ref_p.data());
    ...
    _FORCE_INLINE_ constexpr FE::optional<algorithm::string::range> find(const char_type* const target_substring_ptrc_p, size_type position_p = 0) const noexcept
    {
        FE_EXIT(target_substring_ptrc_p == nullptr, "ERROR: target_substring_ptrc_p is nullptr", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR);
        FE_ASSERT(position_p > algorithm::string::string_length(this->m_fstring), "ERROR: position_p cannot be greater than the left operand string length.");
        FE::optional<algorithm::string::range> l_result = algorithm::string::search_very_first_substring(this->m_fstring + position_p, target_substring_ptrc_p);
        l_result->_begin += position_p;
        l_result->_end += position_p;
        return l_result;
    }
    ...
    {
        FE_ASSERT(position_p > algorithm::string::string_length(this->m_fstring), "ERROR: position_p cannot be greater than the left operand string length.");
        algorithm::string::char_search_result l_result = algorithm::string::search_very_first_char(this->m_fstring + position_p, target_character_p);
        l_result->_begin += position_p;
        l_result->_end += position_p;
        return l_result;
    }
    ...
    {
        FE_ASSERT(position_p > algorithm::string::string_length(this->m_fstring), "ERROR: position_p cannot be greater than the left operand string length.");
        return algorithm::string::search_very_last_substring_within_range(this->m_fstring, algorithm::string::range{0, position_p}, target_substring_ref_p.data());
    }
    ...
    _FORCE_INLINE_ constexpr FE::optional<algorithm::string::range> rfind(const char_type* const target_substring_ptrc_p, size_type position_p = 0) const noexcept
    {
        FE_EXIT(target_substring_ptrc_p == nullptr, "ERROR: target_substring_ptrc_p is nullptr", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR);
        FE_ASSERT(position_p > algorithm::string::string_length(this->m_fstring), "ERROR: position_p cannot be greater than the left operand string length.");
        return algorithm::string::search_very_last_substring_within_range(this->m_fstring, algorithm::string::range{0, position_p}, target_substring_ptrc_p);
    }
    ...
    {
        FE_ASSERT(position_p > algorithm::string::string_length(this->m_fstring), "ERROR: position_p cannot be greater than the left operand string length.");
        return algorithm::string::search_very_last_char_within_range(this->m_fstring, algorithm::string::range{0, position_p}, target_character_p);;
    }
