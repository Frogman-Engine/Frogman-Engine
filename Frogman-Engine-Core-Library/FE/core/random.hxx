...
class random_integer final
{
    ...
    FE::optional<::std::mt19937_64> m_value_generator;
    FE::optional<::std::uniform_int_distribution<T>> m_uniform_int_distribution;
...
public:
    ...
    {
        this->m_uniform_int_distribution.construct(min_range_p, max_range_p);
...
class random_float final
{
    ...
    FE::optional<::std::mt19937_64> m_value_generator;
    FE::optional<::std::uniform_real_distribution<T>> m_uniform_real_distribution;
...
public:
    ...
    {
        this->m_uniform_real_distribution.construct(min_range_p, max_range_p);
