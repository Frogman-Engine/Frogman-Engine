...
public:												
	using underlying_container = ::std::unordered_map<std::string /* NO NEW OPERATORS PLZ! std::string needs to be interchanged with FE::cstring(compile-time constant string) for better performance.*/, ::FE::task_base*>; 
	/* 
