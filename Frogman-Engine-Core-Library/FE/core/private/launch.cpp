...
void ::FE::internal::engine_main::initialize_engine(_MAYBE_UNUSED_ engine_main_initialization_arguments engine_main_initialization_arguments_p) noexcept
{
	...
	exception::s_logging_strategy_ptr = engine_main_initialization_arguments_p._exception_initialization_arguments._exception_logging_strategy_ptr;
	...
	::FE::internal::logger::s_logging_strategy_ptr = engine_main_initialization_arguments_p._logger_initialization_arguments._logging_strategy_ptr;
