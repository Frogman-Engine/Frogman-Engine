...
public:
    _FORCE_INLINE_ constexpr compile_time_constant_string() noexcept {}
    _FORCE_INLINE_ _CONSTEXPR20_ ~compile_time_constant_string() noexcept {}
    ...
    _FORCE_INLINE_ constexpr var::uint64 max_length() const noexcept { return ::FE::max_value<var::uint64>(); }
    ...
    _FORCE_INLINE_ constexpr void copy_substring(index_t begin_p, index_t end_p, char_type* const in_out_buffer_ptrc_p, size_t in_out_buffer_capacity_p) const noexcept
    {
    ...
    _FORCE_INLINE_ constexpr ::std::optional<algorithm::string::range> find(compile_time_constant_string<char_type>& target_substring_ref_p, index_t position_p = 0) const noexcept
    {
        ...
        ::std::optional<algorithm::string::range> l_result = algorithm::string::search_very_first_substring(this->data() + position_p, target_substring_ref_p.data());
        l_result->_begin += position_p;
        l_result->_end += position_p;
        return l_result;
    }
    _FORCE_INLINE_ constexpr ::std::optional<algorithm::string::range> find(const char_type* const target_substring_ptrc_p, index_t position_p = 0) const noexcept
    {
        FE_EXIT(target_substring_ptrc_p == nullptr, "ERROR: target_substring_ptrc_p is nullptr", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR);
        FE_ASSERT(position_p > algorithm::string::string_length(this->data()), "ERROR: position_p cannot be greater than the left operand string length.");
        ::std::optional<algorithm::string::range> l_result = algorithm::string::search_very_first_substring(this->data() + position_p, target_substring_ptrc_p);
        l_result->_begin += position_p;
        l_result->_end += position_p;
        return l_result;
    }
    ...
    _FORCE_INLINE_ constexpr ::std::optional<algorithm::string::range> rfind(compile_time_constant_string<char_type>& target_substring_ref_p, index_t position_p = 0) const noexcept
    {
        FE_ASSERT(position_p > algorithm::string::string_length(this->data()), "ERROR: position_p cannot be greater than the left operand string length.");
    ...
    _FORCE_INLINE_ constexpr ::std::optional<algorithm::string::range> rfind(const char_type* const target_substring_ptrc_p, index_t position_p = 0) const noexcept
    {
        FE_EXIT(target_substring_ptrc_p == nullptr, "ERROR: target_substring_ptrc_p is nullptr", FE::MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR);
        FE_ASSERT(position_p > algorithm::string::string_length(this->data()), "ERROR: position_p cannot be greater than the left operand string length.");
    ...
    _FORCE_INLINE_ constexpr algorithm::string::char_count<char_type> count_all_corresponding_chars(const char_type target_character_p, index_t position_p = 0) const noexcept
    {
        FE_ASSERT(position_p > algorithm::string::string_length(this->data()), "ERROR: position_p cannot be greater than the left operand string length.");
