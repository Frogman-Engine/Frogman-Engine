...
TEST(FE_algorithm_string, search_first_substring)
{
	...
	FE::optional l_result = ::FE::algorithm::string::search_first_substring<var::character>(l_string, "Orange County");
...
TEST(FE_algorithm_string, search_last_substring)
{
	...
	FE::optional l_result = ::FE::algorithm::string::search_last_substring<var::character>(l_string, "son");
...
TEST(FE_algorithm_string, search_first_substring_within_range)
{
	...
	FE::optional l_result = ::FE::algorithm::string::search_first_substring_within_range<var::character>(l_string, string::range{0, 17}, "Love never fails.");
	EXPECT_TRUE(l_result.has_value());
...
TEST(FE_algorithm_string, search_last_substring_within_range)
{
	...
	FE::optional l_result = ::FE::algorithm::string::search_last_substring_within_range<var::character>(l_string, string::range{0, 21}, "love");
	char l_substring[7] = "\0";
