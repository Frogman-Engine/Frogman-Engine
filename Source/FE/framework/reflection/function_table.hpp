...
// Todo: replace std::any with task result queue.
...
public:
	...
	_FORCE_INLINE_ static std::any invoke_function(const typename underlying_container::key_type& key_p, Arguments arguments_p = FE::arguments<void>()) noexcept
	{
	...
	_FORCE_INLINE_ static std::any invoke_method(C& in_out_instance_p, const typename underlying_container::key_type& key_p, Arguments arguments_p = FE::arguments<void>()) noexcept
	{
		boost::shared_lock_guard<lock_type> l_shared_mutex(s_lock);
