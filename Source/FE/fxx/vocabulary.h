...
enum struct VOCABULARY
{
	...
	_LITERAL_TRUE, _LITERAL_FALSE,
	_LITERAL_NULL, 

	_LITERAL_BINARY, _LITERAL_HEXADECIMAL, 
	...
	_TYPE_TASK, _TYPE_THREAD, 

	_TYPE_QUALIFIER_ATOMIC,
	_TYPE_QUALIFIER_VAR,

	_SYMBOL_PTR, _SYMBOL_REF, _SYMBOL_SMART_PTR,
	...
	_KEYWORD_CLASS, _KEYWORD_STRUCT, _KEYWORD_ENUM,
...
const robin_hood::unordered_map<FE::ASCII*, VOCABULARY, FE::hash<FE::ASCII*>> g_fxx_language_vocabulary_map = {
	...
	{"__ptr64", VOCABULARY::_TYPE_PTR64}, {"task", VOCABULARY::_TYPE_TASK}, {"thread", VOCABULARY::_TYPE_THREAD}, 
	
	{"atomic", VOCABULARY::_TYPE_QUALIFIER_ATOMIC},
	{"var", VOCABULARY::_TYPE_QUALIFIER_VAR}, 
	
	{"unsafe", VOCABULARY::_KEYWORD_UNSAFE}, 	
	
	{"*", VOCABULARY::_SYMBOL_PTR}, {"&", VOCABULARY::_SYMBOL_REF}, {"^", VOCABULARY::_SYMBOL_SMART_PTR},
	
	{"constexpr", VOCABULARY::_SPECIFIER_CONSTEXPR}, {"decltype", VOCABULARY::_SPECIFIER_DECLTYPE}, {"alignas", VOCABULARY::_SPECIFIER_ALIGN_AS},
	...
	{"class", VOCABULARY::_KEYWORD_CLASS},	{"struct", VOCABULARY::_KEYWORD_STRUCT}, {"enum", VOCABULARY::_KEYWORD_ENUM},
