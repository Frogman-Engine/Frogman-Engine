#ifndef _FE_CORE_PRIVATE_SMART_REF_BASE_HPP_
#define _FE_CORE_PRIVATE_SMART_REF_BASE_HPP_
...
protected:
	_FORCE_INLINE_ static ref_table_key_type __register_property_address(void* value_p) noexcept
	{
...
class ref_base : public smart_ref_base
{
public:
	using base_type = smart_ref_base;
...
protected:
	_FORCE_INLINE_ static void* __get_property_address(ref_table_key_type key_p) noexcept
	{
