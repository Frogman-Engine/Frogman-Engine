...
struct hash<T, HasherType, HASH_INPUT_DATA_TYPE::_ADDRESS> : public hash_base
{
...
template<typename T, HASHER_TYPE HasherType>
struct hash<T, HasherType, HASH_INPUT_DATA_TYPE::_C_STRING> : public hash_base
{
	using base = hash_base;
...
template<typename T, HASHER_TYPE HasherType>
struct hash<T, HasherType, HASH_INPUT_DATA_TYPE::_STRING_CLASS> : public hash_base
{
	using base = hash_base;
...
template<typename T, HASHER_TYPE HasherType>
struct hash<T, HasherType, HASH_INPUT_DATA_TYPE::_BINARY> : public hash_base
{
	using base = hash_base;
