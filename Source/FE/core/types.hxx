...
public:
	_CONSTEXPR_ _FORCE_INLINE_ ref() noexcept : m_ref_ptr() {}
	_CONSTEXPR20_ _FORCE_INLINE_ ~ref() noexcept {}

	_CONSTEXPR20_ _FORCE_INLINE_ ref(T& ref_p) noexcept : m_ref_ptr(&ref_p) {}

	_CONSTEXPR20_ _FORCE_INLINE_ ref(const ref& cref_p) noexcept : m_ref_ptr(cref_p.m_ref_ptr) {}
	_CONSTEXPR20_ _FORCE_INLINE_ ref(ref&& ref_p) noexcept : m_ref_ptr(ref_p.m_ref_ptr) { ref_p.m_ref_ptr = nullptr; }
