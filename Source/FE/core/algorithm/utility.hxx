...
template<typename T>
_CONSTEXPR20_ _FORCE_INLINE_ void swap(T& first_in_out_ref_p, T& second_in_out_ref_p) noexcept
{
...
_CONSTEXPR20_ _FORCE_INLINE_ integral_info<unsigned_integral_type> string_to_uint(const char_type* const integral_string_ptrc_p) noexcept
{
...
_CONSTEXPR20_ _FORCE_INLINE_ integral_info<signed_integral_type> string_to_int(const char_type* integral_string_ptr_p) noexcept
{
...
_CONSTEXPR20_ _FORCE_INLINE_ boolean string_to_boolean(const char_type* const string_ptrc_p) noexcept
{
...
_CONSTEXPR20_ _FORCE_INLINE_ real_info<float_type> string_to_float(const char_type* float_string_ptr_p) noexcept
{
...
template<typename integral_type>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ var::uint8 count_integral_digit_length(integral_type value_p) noexcept
{
...
template<typename char_type>
_CONSTEXPR20_ _FORCE_INLINE_ void int_to_string(char_type* const string_out_ptrc_p, _MAYBE_UNUSED_ length_t input_string_capacity_p, var::int64 value_p) noexcept
{
...
template<typename char_type>
_CONSTEXPR20_ _FORCE_INLINE_ void uint_to_string(char_type* const string_out_ptrc_p, _MAYBE_UNUSED_ length_t input_string_capacity_p, var::uint64 value_p) noexcept
{
    static_assert(FE::is_char<char_type>::value, "an illegal type of value_p assigned to the template argument char_type");
    ABORT_IF(string_out_ptrc_p == nullptr, "NULLPTR DETECTED: string_out_ptrc_p is nullptr.");
...
template<typename char_type>
_CONSTEXPR20_ _FORCE_INLINE_ void float_to_string(char_type* const string_out_ptrc_p, length_t input_string_capacity_p, float64 value_p) noexcept
{
    static_assert(FE::is_char<char_type>::value, "an illegal type of value_p assigned to the template argument char_type");
    ABORT_IF(string_out_ptrc_p == nullptr, "NULLPTR DETECTED: string_out_ptrc_p is nullptr.");
...
template<typename char_type>
_CONSTEXPR20_ _FORCE_INLINE_ const char_type* boolean_to_string(boolean value_p) noexcept
{
    static_assert(FE::is_char<char_type>::value, "an illegal type of value_p assigned to the template argument char_type");
...
_CONSTEXPR20_ _FORCE_INLINE_ void any_object_binary_representation(char_type* const dest_buffer_ptrc_p, capacity_t dest_buffer_capacity_p, T& object_ref_p)
{
...
template<typename char_type, typename T>
_CONSTEXPR20_ _FORCE_INLINE_ const char_type* any_primitive_to_string(T value_p) noexcept
{
...
template<typename char_type, typename T>
_CONSTEXPR20_ _FORCE_INLINE_ void any_primitive_to_string(char_type* const dest_buffer_ptrc_p, capacity_t dest_buffer_capacity_p, T value_p) noexcept
{
    static_assert(FE::is_primitive<T>::value == true, "static assertion failed: T must be a primitive type.");
...
_CONSTEXPR20_ _FORCE_INLINE_ const char_type* any_to_string(U& value_p) noexcept
{
...
template<typename char_type, typename U>
_CONSTEXPR20_ _FORCE_INLINE_ void any_to_string(char_type* const dest_buffer_ptrc_p, capacity_t dest_buffer_capacity_p, U& value_p) noexcept
{
    if constexpr (std::is_class< typename std::remove_reference< decltype(value_p) >::type >::value == true)
    {
