...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ char_count<CharT> count_chars(const CharT* string_p, const CharT target_p) noexcept
{
    ...
    return char_count<CharT>{l_target_char_buffer, l_match_count};
}
...
template <typename CharT>
_FORCE_INLINE_ void copy_string(CharT* const destination_out_p, _MAYBE_UNUSED_ capacity_t destination_size_p, const CharT* const source_p, capacity_t source_size_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ...
    std::memcpy(destination_out_p, source_p, source_size_p * sizeof(CharT));
    destination_out_p[source_size_p] = _NULL_;
}


template <typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ uint64 string_length(const CharT* const string_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p), nullptr);
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ char_count<CharT> count_chars_within_range(const CharT* string_p, const range string_range_p, const CharT target_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p), nullptr);
    ...
    FE_ASSERT(string_length(string_p) > string_range_p._end, "${%s@0}: the ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_OUT_OF_RANGE), TO_STRING(string_length(string_p)), TO_STRING(string_range_p._end));
...
template <typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ boolean string_comparison(const CharT* lstr_p, const CharT* rstr_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
...
template <typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ boolean compare_ranged_strings(const CharT* const lstr_p, const range lstr_range_p, const CharT* const rstr_p, const range rstr_range_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
...
template <typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ boolean insensitive_string_comparison(const CharT* const lstr_p, const CharT* const rstr_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(lstr_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(lstr_ptr_p), nullptr);
    FE_ASSERT(rstr_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(rstr_ptr_p), nullptr);
...
template <typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ boolean insensitive_ranged_string_comparison(const CharT* const lstr_p, const range lstr_range_p, const CharT* const rstr_p, const range rstr_range_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(lstr_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(lstr_ptr_p), nullptr);
    FE_ASSERT(rstr_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(rstr_ptr_p), nullptr);
...
template <typename CharT>
_CONSTEXPR20_ _FORCE_INLINE_ void string_concatenation(CharT* const destination_out_p, _MAYBE_UNUSED_ count_t destination_total_count_p, const CharT* const source_p, count_t source_total_count_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(destination_out_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(destination_out_p), nullptr);
    FE_ASSERT(source_p == nullptr, "${%s@0}: ${%s@1} is ${%p@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(source_p), nullptr);
    ...
    length_t l_destination_string_length = algorithm::string::string_length<CharT>(destination_out_p);
...
template<typename CharT>
_CONSTEXPR20_ _FORCE_INLINE_ void concatenate_strings(CharT* const out_string_buffer_p, _MAYBE_UNUSED_ size_t string_buffer_size_p, ::std::initializer_list<const CharT* const>&& strings_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ABORT_IF(out_string_buffer_p == nullptr, "NULLPTR DETECTED: out_string_buffer_p is nullptr.");

    var::size_t l_current_begin_index = algorithm::string::string_length(out_string_buffer_p);
...
template<typename CharT>
_CONSTEXPR20_ _FORCE_INLINE_ void concatenate_characters(CharT* const out_string_buffer_p, _MAYBE_UNUSED_ size_t string_buffer_size_p, ::std::initializer_list<const CharT>&& chars_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ...
    var::length_t l_string_buffer_length = algorithm::string::string_length(out_string_buffer_p);
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ _FORCE_INLINE_ std::optional<char_info<CharT>> search_first_char(const CharT* const string_p, const CharT target_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ...
    while (*l_string_pointer != _NULL_)
    {
        ...
        {
            return std::make_optional(char_info<CharT>{*l_string_pointer, static_cast<index_t>(l_string_pointer - string_p) });
        }
        ++l_string_pointer;
    }
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<char_info<CharT>> search_last_char(const CharT* const string_p, const CharT target_char_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p));

    FE::const_reverse_iterator<FE::contiguous_iterator<const CharT>> l_string_rbegin = string_p + (string_length(string_p)-1);
    ...
    while (l_string_rbegin != l_string_rend)
    {
        ...
        {
            return std::make_optional(char_info<CharT>{*l_string_rbegin, static_cast<index_t>(l_string_rbegin.operator->() - string_p) });
        }
        ++l_string_rbegin;
    }
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<char_info<CharT>> search_first_char_within_range(const CharT* const string_p, const range string_range_p, const CharT target_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p));
    ...
    FE_ASSERT(string_length(string_p) < string_range_p._end, "${%s@0}: ${%s@2} cannot be greater than the length of ${%s@1}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_OUT_OF_RANGE), TO_STRING(string_length(string_p)), TO_STRING(string_range_p._end));
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<char_info<CharT>> search_last_char_within_range(const CharT* const string_p, const range string_range_p, const CharT target_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p));
    FE_ASSERT(string_range_p._begin > string_range_p._end, "${%s@0}: ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_OUT_OF_RANGE), TO_STRING(string_range_p._begin), TO_STRING(string_range_p._end));
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<range> search_first_substring(const CharT* const string_p, const CharT* const target_substring_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p));
    ...
    length_t l_string_length = string_length(string_p);
    length_t l_target_substring_length = string_length(target_substring_p);
    ...
    if (compare_ranged_strings(string_p, range{ l_begin, l_end }, target_substring_p, range{ 0, l_target_substring_length }))
    {
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<range> search_last_substring(const CharT* const string_p, const CharT* const target_substring_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(string_p));
    FE_ASSERT(target_substring_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(target_substring_p));
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<range> search_first_substring_within_range(const CharT* const string_p, const range string_range_p, const CharT* const target_substring_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ...
    FE_ASSERT(string_length(string_p) < string_range_p._end, "${%s@0}: ${%s@1} cannot be greater than the length of ${%s@2}.", TO_STRING(string_length(string_p)), TO_STRING(string_range_p._end));
...
template<typename CharT>
_NODISCARD_ _CONSTEXPR20_ std::optional<range> search_last_substring_within_range(const CharT* const string_p, const range string_range_p, const CharT* const target_substring_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    FE_ASSERT(string_range_p._begin > string_range_p._end, "${%s@0}: ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(string_range_p._begin), TO_STRING(string_range_p._end));
    FE_ASSERT(string_length(string_p) < string_range_p._end, "${%s@0}: ${%s@1} cannot be greater than the length of ${%s@2}.", TO_STRING(string_length(string_p)), TO_STRING(string_range_p._end));
    ...
    length_t l_string_length = string_range_p._end - string_range_p._begin;
    length_t l_target_substring_length = algorithm::string::string_length(target_substring_p);
...
template<typename CharT>
_CONSTEXPR20_ _FORCE_INLINE_ void invert_string(CharT* const in_out_string_p) noexcept
{
    FE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "CharT is not a valid character type");
    ...
    var::index_t l_end = string_length(in_out_string_p);
