...
template<FORWARD_DATA ArgumentsForwardingMode, typename F>
class function;
...
public:
    ...
    {
        return (this->m_function_pointer == nullptr) ? false : true;
    }
...
template<FORWARD_DATA ArgumentsForwardingMode, class C, typename F>
class method;
...
public:
    ...
    _CONSTEXPR20_ _FORCE_INLINE_ operator bool() const noexcept
    {
        return (this->m_method_pointer == nullptr) ? false : true;
    }
...
struct cpp_style_task<C, TaskImpl, FE::FORWARD_DATA::_AS_RVALUE_REF, ArgumentsBufferTypes...> : public task_base
{
    ...
    _CONSTEXPR20_ _FORCE_INLINE_ cpp_style_task(cpp_style_task& other_p) noexcept : _arguments_buffer(other_p._arguments_buffer), _method(other_p._method), _instance_ptr(other_p._instance_ptr) {}
    ...
    virtual void operator()(void) noexcept override
    {
        ...
        else if constexpr (task_type::has_void_return_type == false)
        {
            if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_0)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_1)
            {
                this->_task_result = std::forward<task_result_buffer_type>(this->_method(*this->_instance_ptr, std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_2)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first), std::forward<typename arguments_buffer_type::second_type>(this->_arguments_buffer._second)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_3)
            {
...
struct cpp_style_task<C, TaskImpl, FE::FORWARD_DATA::_AS_LVALUE_REF, ArgumentsBufferTypes...> : public task_base
{
    ...
    virtual void operator()(void) noexcept override
    {
        ...
        else if constexpr (task_type::has_void_return_type == false)
        {
            ...
            {
                this->_task_result = std::forward<task_result_buffer_type>(this->_method(*this->_instance_ptr, this->_arguments_buffer._first));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_2)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_3)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_4)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_5)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_6)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_7)
            {
                this->_task_result = std::forward(this->_method(*this->_instance_ptr, this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth, this->_arguments_buffer._seventh));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_8)
            {
...
struct c_style_task<TaskImpl, FE::FORWARD_DATA::_AS_RVALUE_REF, ArgumentsBufferTypes...> : public task_base
{
    ...
    _CONSTEXPR20_ _FORCE_INLINE_ c_style_task(c_style_task& other_p) noexcept : _arguments_buffer(other_p._arguments_buffer), _function(other_p._function) {}
    ...
    virtual void operator()(void) noexcept override
    {
        ...
        else if constexpr (task_type::has_void_return_type == false)
        {
            if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_0)
            {
                this->_task_result = std::forward(this->_function());
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_1)
            {
                this->_task_result = std::forward<task_result_buffer_type>(this->_function(std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_2)
            {
                this->_task_result = std::forward(this->_function(std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first), std::forward<typename arguments_buffer_type::second_type>(this->_arguments_buffer._second)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_3)
            {
                this->_task_result = std::forward(this->_function(std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first), std::forward<typename arguments_buffer_type::second_type>(this->_arguments_buffer._second), std::forward<typename arguments_buffer_type::third_type>(this->_arguments_buffer._third)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_4)
            {
                this->_task_result = std::forward(this->_function(std::forward<typename arguments_buffer_type::first_type>(this->_arguments_buffer._first), std::forward<typename arguments_buffer_type::second_type>(this->_arguments_buffer._second), std::forward<typename arguments_buffer_type::third_type>(this->_arguments_buffer._third), std::forward<typename arguments_buffer_type::fourth_type>(this->_arguments_buffer._fourth)));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_5)
            {
...
struct c_style_task<TaskImpl, FE::FORWARD_DATA::_AS_LVALUE_REF, ArgumentsBufferTypes...> : public task_base
{
    ...
    virtual void operator()(void) noexcept override
    {
        ...
        else if constexpr (task_type::has_void_return_type == false)
        {
            ...
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_2)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_3)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_4)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_5)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_6)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_7)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth, this->_arguments_buffer._seventh));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_8)
            {
                this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth, this->_arguments_buffer._seventh, this->_arguments_buffer._eighth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_9)
            {
                *this->_task_result = std::forward(this->_function(this->_arguments_buffer._first, this->_arguments_buffer._second, this->_arguments_buffer._third, this->_arguments_buffer._fourth, this->_arguments_buffer._fifth, this->_arguments_buffer._sixth, this->_arguments_buffer._seventh, this->_arguments_buffer._eighth, this->_arguments_buffer._ninth));
                return;
            }
            else if constexpr (this->_arguments_buffer.arguments_count == ARGUMENTS_COUNT::_10)
            {
