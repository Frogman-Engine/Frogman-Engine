...
private:
    struct initializer
    {
        initializer(character* const logfile_folder_name_p
            ,
...
public:
    ...
    _FORCE_INLINE_ ~logger() noexcept {}
...
public:
    static void log(character* const logfile_folder_name_p, character* const message_p, character* const file_name_p, character* const function_name_p, int32 line_p) noexcept;
};
