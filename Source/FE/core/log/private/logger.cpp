...
logger::initializer::initializer(character* const logfile_folder_name_p,
#ifdef _WINDOWS_64BIT_OS_
    wchar* const logfile_inner_folder_name_p
#elif defined(_LINUX_64BIT_OS_)
    character* const logfile_inner_folder_name_p
#endif
                                ) noexcept
{
    ::std::filesystem::path l_directory_name = (::std::filesystem::current_path() / logfile_folder_name_p);
    ...
    ::std::filesystem::path l_path_to_log_dump_file = l_directory_name / logfile_inner_folder_name_p;
    ...
    ::FE::algorithm::TagType::concatenate_strings<var::character>
        (
            l_full_path_to_the_file,
            _FULL_PATH_TO_FILE_MAX_LENGTH_,
            {
...
void logger::log(character* const logfile_folder_name_p, character* const message_p, character* const file_name_p, character* const function_name_p, int32 line_p) noexcept
{
#ifdef _WINDOWS_64BIT_OS_
    ...
    thread_local static logger::initializer tl_s_initializer(logfile_folder_name_p, l_date_info_string);
