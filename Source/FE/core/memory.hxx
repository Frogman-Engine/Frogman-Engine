...
#ifdef _AVX512_
_FORCE_INLINE_ void unaligned_memset_with_avx512(void* const dest_out_pointer_p, int8 value_p, size_t total_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(total_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(total_bytes_p));

	__m512i* l_m512i_dest_ptr = static_cast<__m512i*>(dest_out_pointer_p);
...
_FORCE_INLINE_ void aligned_memset_with_avx512(void* const dest_out_pointer_p, int8 value_p, size_t total_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(total_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(total_bytes_p));
	FE_ASSERT(MODULO_BY_64(reinterpret_cast<uintptr_t>(dest_out_pointer_p)) != 0, "${%s@0}: The address is not aligned by 64.", TO_STRING(MEMORY_ERROR_1XX::_ERROR_ILLEGAL_ADDRESS_ALIGNMENT));
...
_FORCE_INLINE_ void unaligned_memcpy_with_avx512(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
...
_FORCE_INLINE_ void aligned_memcpy_with_avx512(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
	FE_ASSERT(MODULO_BY_64(reinterpret_cast<uintptr_t>(dest_out_pointer_p)) != 0, "${%s@}: dest_out_pointer_p is not aligned by 64.", TO_STRING(MEMORY_ERROR_1XX::_ERROR_ILLEGAL_ADDRESS_ALIGNMENT));
...
_FORCE_INLINE_ void dest_aligned_memcpy_with_avx512(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
...
_FORCE_INLINE_ void source_aligned_memcpy_with_avx512(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
...
#elif defined(_AVX_)
_FORCE_INLINE_ void unaligned_memset_with_avx(void* const dest_out_pointer_p, int8 value_p, size_t total_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(total_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(total_bytes_p));

	__m256i* l_m256i_dest_ptr = static_cast<__m256i*>(dest_out_pointer_p);
...
_FORCE_INLINE_ void aligned_memset_with_avx(void* const dest_out_pointer_p, int8 value_p, size_t total_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(total_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(total_bytes_p));
	FE_ASSERT(MODULO_BY_32(reinterpret_cast<uintptr_t>(dest_out_pointer_p)) != 0, "${%s@0}: The address is not aligned by 32.", TO_STRING(MEMORY_ERROR_1XX::_ERROR_ILLEGAL_ADDRESS_ALIGNMENT));
...
_FORCE_INLINE_ void unaligned_memcpy_with_avx(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
...
_FORCE_INLINE_ void aligned_memcpy_with_avx(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
	FE_ASSERT(MODULO_BY_32(reinterpret_cast<uintptr_t>(dest_out_pointer_p)) != 0, "${%s@0}: ${%s@1} is not aligned by 32.", TO_STRING(MEMORY_ERROR_1XX::_ERROR_ILLEGAL_ADDRESS_ALIGNMENT), TO_STRING(dest_out_pointer_p));
...
_FORCE_INLINE_ void dest_aligned_memcpy_with_avx(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
...
_FORCE_INLINE_ void source_aligned_memcpy_with_avx(void* const dest_out_pointer_p, const void* const source_pointer_p, FE::size_t bytes_to_copy_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(source_pointer_p));
	FE_ASSERT(bytes_to_copy_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(bytes_to_copy_p));
...
#ifdef _AVX512_
#define UNALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::FE::unaligned_memset_with_avx512(dest_out_pointer_p, value_p, total_bytes_p)
#define ALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::FE::aligned_memset_with_avx512(dest_out_pointer_p, value_p, total_bytes_p)
#define UNALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::unaligned_memcpy_with_avx512(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::aligned_memcpy_with_avx512(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::dest_aligned_memcpy_with_avx512(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::source_aligned_memcpy_with_avx512(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)

#elif defined(_AVX_)
#define UNALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::FE::unaligned_memset_with_avx(dest_out_pointer_p, value_p, total_bytes_p)
#define ALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::FE::aligned_memset_with_avx(dest_out_pointer_p, value_p, total_bytes_p)
#define UNALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::unaligned_memcpy_with_avx(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::aligned_memcpy_with_avx(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::dest_aligned_memcpy_with_avx(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::source_aligned_memcpy_with_avx(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)

#else
#define UNALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::std::memset(dest_out_pointer_p, value_p, total_bytes_p)
#define ALIGNED_MEMSET(dest_out_pointer_p, value_p, total_bytes_p) ::std::memset(dest_out_pointer_p, value_p, total_bytes_p)
#define UNALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::std::memcpy(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::std::memcpy(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::memcpy(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#define SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p) ::FE::memcpy(dest_out_pointer_p, source_pointer_p, bytes_to_copy_p)
#endif


_FORCE_INLINE_ void unaligned_memcpy(void* const dest_out_pointer_p, length_t dest_length_p, size_t dest_element_bytes_p, const void* const source_memblock_pointer_p, length_t source_length_p, size_t source_element_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));

	FE_ASSERT(dest_length_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(dest_element_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_element_bytes_p == 0, "${%s@0}: ${%s@1} is 0.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_INVALID_SIZE), TO_STRING(dest_out_pointer_p));
	...
	{
		UNALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_dest_size);
	}
	else
	{
		UNALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_source_size);
	}
}


_FORCE_INLINE_ void aligned_memcpy(void* const dest_out_pointer_p, length_t dest_length_p, size_t dest_element_bytes_p, const void* const source_memblock_pointer_p, length_t source_length_p, size_t source_element_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (l_source_size >= l_dest_size)
	{
		ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_dest_size);
	}
	else
	{
		ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_source_size);
	}
}


_FORCE_INLINE_ void dest_aligned_memcpy(void* const dest_out_pointer_p, length_t dest_length_p, size_t dest_element_bytes_p, const void* const source_memblock_pointer_p, length_t source_length_p, size_t source_element_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (l_source_size >= l_dest_size)
	{
		DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_dest_size);
	}
	else
	{
		DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_source_size);
	}
}

_FORCE_INLINE_ void source_aligned_memcpy(void* const dest_out_pointer_p, length_t dest_length_p, size_t dest_element_bytes_p, const void* const source_memblock_pointer_p, length_t source_length_p, size_t source_element_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (l_source_size >= l_dest_size)
	{
		SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_dest_size);
	}
	else
	{
		SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, l_source_size);
	}
}


_FORCE_INLINE_ void unaligned_memcpy(void* const dest_out_pointer_p, size_t dest_bytes_p, const void* const source_memblock_pointer_p, size_t source_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	{
		UNALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, dest_bytes_p);
	}
	else
	{
		UNALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, source_bytes_p);
	}
}


_FORCE_INLINE_ void aligned_memcpy(void* const dest_out_pointer_p, size_t dest_bytes_p, const void* const source_memblock_pointer_p, size_t source_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (source_bytes_p >= dest_bytes_p)
	{
		ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, dest_bytes_p);
	}
	else
	{
		ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, source_bytes_p);
	}
}


_FORCE_INLINE_ void dest_aligned_memcpy(void* const dest_out_pointer_p, size_t dest_bytes_p, const void* const source_memblock_pointer_p, size_t source_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (source_bytes_p >= dest_bytes_p)
	{
	   DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, dest_bytes_p);
	}
	else
	{
		DEST_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, source_bytes_p);
	}
}

_FORCE_INLINE_ void source_aligned_memcpy(void* const dest_out_pointer_p, size_t dest_bytes_p, const void* const source_memblock_pointer_p, size_t source_bytes_p) noexcept
{
	FE_ASSERT(dest_out_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	FE_ASSERT(source_memblock_pointer_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(MEMORY_ERROR_1XX::_FATAL_ERROR_NULLPTR), TO_STRING(dest_out_pointer_p));
	...
	if (source_bytes_p >= dest_bytes_p)
	{
		SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, dest_bytes_p);
	}
	else
	{
		SOURCE_ALIGNED_MEMCPY(dest_out_pointer_p, source_memblock_pointer_p, source_bytes_p);
	}
}
...
class type_traits<T, allocated_from, TYPE_TRIVIALITY::_TRIVIAL>
{
public:
	_MAYBE_UNUSED_ static constexpr inline TYPE_TRIVIALITY is_trivially_constructible_and_destructible = TYPE_TRIVIALITY::_TRIVIAL;
...
template<typename T, class allocated_from>
class type_traits<T, allocated_from, TYPE_TRIVIALITY::_NOT_TRIVIAL>
{
public:
	_MAYBE_UNUSED_ static constexpr inline TYPE_TRIVIALITY is_trivially_constructible_and_destructible = TYPE_TRIVIALITY::_NOT_TRIVIAL;
