...
public:
	...
	_CONSTEXPR20_ _FORCE_INLINE_ ~iterator() noexcept {}

	_CONSTEXPR20_ _FORCE_INLINE_ reference operator*() noexcept
	{
		return *(this->m_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ pointer operator->() noexcept
	{
		return this->m_iterator;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ reference operator[](index_t index_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ iterator& operator++() noexcept
	{
		this->m_iterator = implementation::increment(this->m_iterator);
		return *this;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ iterator operator++(int) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ difference_type operator-(const iterator& other_cref_p) noexcept
	{
		return implementation::minus(this->m_iterator, other_cref_p.m_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ iterator& operator-=(const iterator& other_cref_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ iterator& operator=(pointer value_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ iterator& operator=(iterator&& rvalue_other_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ var::boolean operator<(const iterator& other_cref_p) noexcept
	{
...
public:
	...
	_CONSTEXPR20_ _FORCE_INLINE_ ~reverse_iterator() noexcept {}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator operator+(difference_type pointer_offset_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator& operator++() noexcept
	{
		this->m_reverse_iterator = implementation::decrement(this->m_reverse_iterator);
		return *this;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator operator++(int) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ difference_type operator-(const reverse_iterator& other_cref_p) noexcept
	{
		return implementation::minus(other_cref_p.m_reverse_iterator, this->m_reverse_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator& operator-=(const reverse_iterator& other_cref_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator& operator=(pointer value_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ reverse_iterator& operator=(reverse_iterator&& rvalue_other_p) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ var::boolean operator<(const reverse_iterator& other_cref_p) noexcept
	{
...
public:
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_reference operator*() noexcept
	{
		return *(this->m_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_pointer operator->() noexcept
	{
		return this->m_iterator;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_reference operator[](index_t index_p) noexcept
	{
		ABORT_IF(index_p == FE::_MAX_VALUE_<index_t>, "ERROR: negative integers cannot be assigned to an index_t variable.");
		return implementation::index(this->m_iterator, index_p);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator operator+(difference_type pointer_offset_p) noexcept
	{
		return implementation::plus(this->m_iterator, pointer_offset_p);
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator& operator++() noexcept
	{
		this->m_iterator = implementation::increment(this->m_iterator);
		return *this;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator operator++(int) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ difference_type operator-(const const_iterator& other_cref_p) noexcept
	{
		return implementation::minus(this->m_iterator, other_cref_p.m_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator& operator-=(const const_iterator& other_cref_p) noexcept
	{
		this->m_iterator = implementation::minus(this->m_iterator, other_cref_p.m_iterator);
		return *this;
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator& operator=(const pointer value_p) noexcept
	{
		this->m_iterator = value_p;
		return *this;
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_iterator& operator=(const_iterator&& rvalue_other_p) noexcept
	{
		this->m_iterator = rvalue_other_p.m_iterator;
		rvalue_other_p.m_iterator = nullptr;
		return *this;
	...
	_CONSTEXPR20_ _FORCE_INLINE_ var::boolean operator<(const const_iterator& other_cref_p) noexcept
	{
		return this->m_iterator < other_cref_p.m_iterator;
	}
...
public:
	...
	_CONSTEXPR20_  const_reference operator*() noexcept
	{
		return *(this->m_reverse_iterator);
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator operator+(difference_type pointer_offset_p) noexcept
	{
		return implementation::minus(this->m_reverse_iterator, pointer_offset_p);
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator& operator++() noexcept
	{
		this->m_reverse_iterator = implementation::decrement(this->m_reverse_iterator);
		return *this;
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator operator++(int) noexcept
	{
	...
	_CONSTEXPR20_ _FORCE_INLINE_ difference_type operator-(const const_reverse_iterator& other_cref_p) noexcept
	{
		return implementation::minus(other_cref_p.m_reverse_iterator, this->m_reverse_iterator);
	}

	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator& operator-=(const const_reverse_iterator& other_cref_p) noexcept
	{
		this->m_reverse_iterator = implementation::plus(this->m_reverse_iterator, other_cref_p.m_reverse_iterator);
		return *this;
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator& operator=(const pointer value_p) noexcept
	{
		this->m_reverse_iterator = value_p;
		return *this;
	}
	...
	_CONSTEXPR20_ _FORCE_INLINE_ const_reverse_iterator& operator=(const_reverse_iterator&& rvalue_other_p) noexcept
	{
		this->m_reverse_iterator = rvalue_other_p.m_reverse_iterator;
		rvalue_other_p.m_reverse_iterator = nullptr;
		return *this;
	...
	_CONSTEXPR20_ _FORCE_INLINE_ var::boolean operator<(const const_reverse_iterator& other_cref_p) noexcept
	{
		return this->m_reverse_iterator < other_cref_p.m_reverse_iterator;
	}
