...
void FE::thread::swap(thread& left_thread_in_out_p, thread& right_thread_in_out_p) noexcept
{
	::std::swap(left_thread_in_out_p.m_thread, right_thread_in_out_p.m_thread);
	::FE::algorithm::utility::swap(left_thread_in_out_p.tl_s_this_thread_instance_id, right_thread_in_out_p.tl_s_this_thread_instance_id);
}
