...
protected:
	...
	using ref_table_key_type = typename std::vector<pointer, FE::std_style::scalable_aligned_allocator<element_type>>::size_type;
	using ref_table_type = std::vector<pointer, FE::std_style::scalable_aligned_allocator<element_type>>;
