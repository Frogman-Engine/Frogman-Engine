...
public:
	constexpr _FORCE_INLINE_ proxy_ptr() noexcept : m_smart_ptr(), m_smart_ptr_end(), m_ref_table_key(invalid_key_value) {}

	_FORCE_INLINE_ proxy_ptr(const proxy_ptr& other_cref_p) noexcept : m_smart_ptr(ref_table_type::__check_ref(other_cref_p.m_ref_table_key, other_cref_p.m_smart_ptr)), m_smart_ptr_end(other_cref_p.m_smart_ptr_end), m_ref_table_key(invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
			this->m_ref_table_key = other_cref_p.m_ref_table_key;
	...
	_FORCE_INLINE_ proxy_ptr(proxy_ptr&& rvalue_p) noexcept : m_smart_ptr(ref_table_type::__check_ref(rvalue_p.m_ref_table_key, rvalue_p.m_smart_ptr)), m_smart_ptr_end(rvalue_p.m_smart_ptr_end), m_ref_table_key(invalid_key_value)
	{
		if (this->m_smart_ptr != nullptr)
		{
			rvalue_p.m_smart_ptr = nullptr;
