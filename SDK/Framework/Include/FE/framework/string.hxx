...
class basic_string final 
{
    ...
    FE_NEGATIVE_STATIC_ASSERT(FE::is_char<CharT>::value == false, "static assertion failed: the template argument CharT is not a valid character type.");
    FE_NEGATIVE_STATIC_ASSERT(std::is_class<Allocator>::value == false, "static assertion failed: the template argument Allocator is not a valid class type.");
    ...
    FE_NEGATIVE_STATIC_ASSERT((std::is_same<CharT, typename Allocator::value_type>::value == false), "static assertion failed: enforcing Allocator's value_type to be equivalent to CharT. The template parameter CharT must be identical to the value_type of the Allocator.");
    FE_NEGATIVE_STATIC_ASSERT((std::is_same<CharT, typename Traits::value_type>::value == false), "static assertion failed: enforcing traits' value_type to be equivalent to CharT. The template parameter CharT must be identical to traits::value_type.");
    FE_NEGATIVE_STATIC_ASSERT(Allocator::is_address_aligned == ADDRESS::_NOT_ALIGNED, "static assertion failed: addresses allocated from the class Allocator must meet the hardware-specific SIMD Alignment requirements.");
...
public:
    ...
    {
        FE_NEGATIVE_ASSERT(position_p >= other_p.m_length, "${%s@0}: ${%s@1} was ${%lu@2}, and ${%s@3} was ${%lu@4}", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_ITERATOR), TO_STRING(position_p), &position_p, TO_STRING(other_p.m_length), &other_p.m_length);
    ...
    {
        FE_NEGATIVE_ASSERT(position_p >= rvalue_p.m_length, "${%s@0}: ${%s@1} was ${%lu@2}, and ${%s@3} was ${%lu@4}", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_ITERATOR), TO_STRING(position_p), &position_p, TO_STRING(rvalue_p.m_length), &rvalue_p.m_length);
    ...
    {
        FE_NEGATIVE_ASSERT((position_p + count_p) >= other_p.m_length, "Assertion failed: (position + count_p) points the outside of string boundary.");
    ...
    {
        FE_NEGATIVE_ASSERT((position_p + count_p) >= rvalue_p.m_length, "Assertion failed: (position + count_p) points the outside of string boundary.");
    ...
    {
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(string_p));
        FE_NEGATIVE_ASSERT(algorithm::string::length(string_p) < count_p, "Assertion failed: count_p cannot be greater than the length of the string.");
    ...
    {
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: the string pointer was a nullptr.");
    ...
    _FE_CONSTEXPR20_ basic_string(InputIterator first_p, InputIterator last_p) noexcept
    {
        ...
        FE_NEGATIVE_STATIC_ASSERT((std::is_same<typename std::remove_const<typename InputIterator::value_type>::type, typename std::remove_const<value_type>::type>::value == false), "Static Assertion Failure: InputIterator's value_type has to be the same as basic_string's value_type.");
    ...
    _FE_CONSTEXPR20_ basic_string(basic_string_view<CharT>& string_view_p, const size_type position_p, const size_type count_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(position_p >= string_view_p.length(), "${%s@0}: The inserting position index value cannot be greater than the length of ${%s@1}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_ITERATOR), TO_STRING(string_view_p));
    ...
    {
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(string_p));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    _FE_CONSTEXPR20_ basic_string& operator=(std::initializer_list<CharT>&& initializer_list_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(initializer_list_p.size() == 0, "${%s@0}: ${%s@1} was empty.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(initializer_list_p));
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT(count_p >= this->capacity(), "${%s@0}: ${%s@1} exceeds string capacity.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_BUFFER_OVERFLOW), TO_STRING(count_p));
    ...
    _FE_CONSTEXPR20_ basic_string& assign(const basic_string& other_p, const size_type input_begin_p, const size_type input_end_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT((input_end_p - input_begin_p) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(input_end_p > other_p.length(), "Assertion failure: the input string capacity overflowed.");
    ...
    _FE_CONSTEXPR20_ basic_string& assign(const value_type* const string_p, const size_type input_begin_p, const size_type input_end_p) noexcept
    {
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT((input_end_p - input_begin_p) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(input_end_p > algorithm::string::length(string_p), "Assertion failure: the input string capacity overflowed.");
    ...
    _FE_CONSTEXPR20_ basic_string& assign(const value_type* const string_p, const size_type size_to_assign_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(size_to_assign_p >= this->capacity(), "Assertion failed: size_to_assign_p exceeds string capacity.");
        FE_NEGATIVE_ASSERT(size_to_assign_p >= algorithm::string::length(string_p), "Assertion failure: the input string capacity overflowed.");
    ...
    _FE_CONSTEXPR20_ basic_string& assign(const_iterator input_begin_p, const_iterator input_end_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(input_begin_p >= input_end_p, "${%s@0}: ${%s@1} must be smaller than ${%s@2}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), TO_STRING(input_begin_p), TO_STRING(input_end_p));
        FE_NEGATIVE_ASSERT((input_end_p - input_begin_p) >= this->capacity(), "${%s@0}: input string range length exceeds string capacity.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT(initializer_list_p.size() >= this->capacity(), "ERROR: initializer_list_p.size() exceeds the string capacity.");
        FE_NEGATIVE_ASSERT(initializer_list_p.size() == 0, "${%s@0}: {%s@1} is an empty initializer_list_p.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(initializer_list_p));
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT(index_p >= this->m_smart_string.capacity(), "${%s@0}: ${%s@1} was ${%lu@2}, and the string capacity was insufficient", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), TO_STRING(index_p), &index_p);
    ...
    {
        FE_NEGATIVE_ASSERT(new_capacity_p == 0, "${%s@0}: Unable to reserve(). ${%s@1} was zero.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(new_capacity_p));
        FE_NEGATIVE_ASSERT(new_capacity_p > this->max_length(), "Assertion Failure: ${%s@0} must not be greater than ${%s@1}.", TO_STRING(new_capacity_p), TO_STRING(this->max_length()));
    ...
    {
        FE_NEGATIVE_ASSERT(extra_capacity_p == 0, "${%s@0}: Unable to extend(). ${%s@1} was zero.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(extra_capacity_p));
        FE_NEGATIVE_ASSERT(extra_capacity_p + this->m_smart_string.capacity() > this->max_length(), "Assertion Failure: ${%s@0} must not be greater than ${%s@1}.", TO_STRING(extra_capacity_p + this->m_smart_string.capacity()), TO_STRING(this->max_length()));
        FE_NEGATIVE_ASSERT(this->m_smart_string.capacity() == 0, "Assertion Failure: Unable to extend an empty string. Please reserve() or resize() before extend() to ensure allocating extra space for the null escape sequence.");
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_length == 0, "${%s@0}: Unable to shrink_to_fit() an empty string instance.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    { 
        FE_NEGATIVE_ASSERT(this->m_length == 0, "${%s@0}: Unable to clear() an empty string instance.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT((position_p + count_p) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(count_p == 0, "ERROR: insert() operation was not successful. size_type count_p was zero.");
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    _FE_CONSTEXPR20_ basic_string& insert(const size_type position_p, const value_type* const string_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT((position_p + l_inout_string_length) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: the input string is nullptr", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT((position_p + other_p.m_length) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT((position_p + (input_end_p - input_begin_p)) >= this->capacity(), "Assertion failure: string capacity overflowed.");
        FE_NEGATIVE_ASSERT(input_begin_p >= input_end_p, "${%s@0}: ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_ITERATOR), TO_STRING(input_begin_p), TO_STRING(input_end_p));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT(input_end_p > other_p.length(), "Assertion failure: the input string capacity overflowed.");
    ...
    {
        FE_NEGATIVE_ASSERT(initializer_list_p.size() == 0, "${%s@0}: the initializer_list_p is empty.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE));
        FE_NEGATIVE_ASSERT((position_p + initializer_list_p.size()) >= this->capacity(), "${%s@0}: string capacity overflowed.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_BUFFER_OVERFLOW));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(this->capacity() < (index_p + count_p), "${%s@0}: string capacity overflowed.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_length >= this->capacity(), "${%s0}: out of capacity", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_length == 0, "${%s0}: Unable to pop an empty fstring", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    _FE_CONSTEXPR20_ basic_string& append(const size_type input_count_p, const value_type value_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(this->capacity() < (this->m_length + input_count_p), "${%s0}: cannot append ${%ld@1} character(s) to the fstring.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), &input_count_p);
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(input_count_p == 0, "${%s0}: ${%s1} is zero", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(input_count_p));
        FE_NEGATIVE_ASSERT(this->capacity() < (this->m_length + input_count_p), "${%s0}: cannot append another fstring that exceeds the capacity of a caller fstring.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(other_p.m_length < (input_count_p + input_position_p), "${%s0}: out of input fstring index boundary.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(cstr_ptrc_p));
        FE_NEGATIVE_ASSERT(input_count_p == 0, "${%s0}: ${%s1} is zero", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(input_count_p));
        FE_NEGATIVE_ASSERT(this->capacity() < (input_position_p + input_count_p), "${%s0}: cannot append another fstring that exceeds the capacity of a caller fstring.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        if(*string_p == null)
        {
            return *this;
    ...
    {
        FE_NEGATIVE_STATIC_ASSERT((std::is_same<typename const_iterator::value_type, value_type>::value == false), "static assertion failed: const_iterator::value_type is not equal to value_type.");
        FE_NEGATIVE_ASSERT(input_begin_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(input_begin_p));
        FE_NEGATIVE_ASSERT(input_end_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(input_end_p));
        FE_NEGATIVE_ASSERT(input_begin_p >= input_end_p, "${%s@0}: input_position_p must not be greater than input_count_p.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(static_cast<size_type>(input_end_p - input_begin_p) + this->m_length >= this->capacity(), "${%s@0}: input string range length exceeds string capacity.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
...
#pragma warning(disable: 26800)
    ...
    {
        FE_NEGATIVE_ASSERT(initializer_list_p.size() == 0, "${%s@0}: The initializer_list_p is empty.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE));
        FE_NEGATIVE_ASSERT(this->capacity() < initializer_list_p.size() + this->m_length, "${%s@0}: initializer_list_p is too large to take the contents.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_BUFFER_OVERFLOW));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
...
#pragma warning(pop)
    ...
    _FE_CONSTEXPR20_ basic_string& operator+=(const basic_string& other_p) noexcept
    {
        ...
        this->m_length += other_p.m_length;
        FE_NEGATIVE_ASSERT( this->m_length >= this->m_smart_string.capacity(), "FE::string overflowed: please reference 'basic_string& operator+=(const basic_string& other_p) noexcept'.");
    ...
    _FE_CONSTEXPR20_ basic_string& operator+=(const value_type* const string_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT( (this->m_length + l_input_string_length) >= this->m_smart_string.capacity(), "FE::string overflowed: please reference 'basic_string& operator+=(const basic_string& other_p) noexcept'.");
    ...
    _FE_CONSTEXPR20_ basic_string& operator+=(const value_type value_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT( (this->m_length + 1) >= this->m_smart_string.capacity(), "FE::string overflowed: please reference 'basic_string& operator+=(const basic_string& other_p) noexcept'.");
    ...
    {
        FE_NEGATIVE_ASSERT(((this->m_length + other_p.m_length) - count_to_be_removed_p) >= this->capacity(), "${%s@0}: failed to replace.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_CAPACITY));
        FE_NEGATIVE_ASSERT(position_p > this->m_length, "${%s@0}: ${%s@1} must not be greater than ${%s@2}.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_RANGE), TO_STRING(position_p), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        ...
        this->m_smart_string[this->m_length] = null;
        FE_NEGATIVE_ASSERT(this->m_length > algorithm::string::length(this->m_smart_string.get()), "length integrity is broken: The replace() opertation failed due to undesired use.");
        return *this;
    }
    ...
    {
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        FE_NEGATIVE_ASSERT(((this->m_length + other_count_p) - count_to_be_removed_p) >= this->capacity(), "${%s@0}: failed to replace.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_CAPACITY));
        FE_NEGATIVE_ASSERT(position_p > this->m_length, "${%s@0}: ${%s@1} must not be greater than ${%s@2}.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_RANGE), TO_STRING(position_p), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(other_position_p > other_p.m_length, "${%s@0}: ${%s@1} must not be greater than ${%s@2}.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_RANGE), TO_STRING(other_position_p), TO_STRING(other_p.m_length));
        ...
        FE_NEGATIVE_ASSERT(count_to_be_removed_p == 0, "${%s@0}: ${%s@1} is zero.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(count_to_be_removed_p));
        FE_NEGATIVE_ASSERT(other_count_p == 0, "${%s@0}: ${%s@1} is zero.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(other_count_p));
    ...
    _FE_CONSTEXPR20_ basic_string& replace(const size_type position_p, const size_type count_to_be_removed_p, const value_type* const string_p, const size_type input_count_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(((this->m_length + input_count_p) - count_to_be_removed_p) >= this->capacity(), "${%s@0}: failed to replace.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_CAPACITY));
        FE_NEGATIVE_ASSERT(count_to_be_removed_p == 0, "${%s@0}: ${%s@1} is zero.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(count_to_be_removed_p));
        FE_NEGATIVE_ASSERT(string_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(string_p));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
        if(*string_p == null)
    ...
    _FE_CONSTEXPR20_ basic_string& replace(const size_type position_p, const size_type count_to_be_removed_p, const value_type* const string_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(((this->m_length + l_input_length) - count_to_be_removed_p) >= this->capacity(), "${%s@0}: failed to replace.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_CAPACITY));
        if(l_input_length == 0)
        {
            return *this;
        }
    ...
    _FE_CONSTEXPR20_ basic_string& replace(const size_type position_p, const size_type count_to_be_removed_p, std::initializer_list<const CharT>&& initializer_list_p) noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(((this->m_length + l_input_size) - count_to_be_removed_p) >= this->capacity(), "${%s@0}: failed to replace.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_OUT_OF_CAPACITY));
        FE_NEGATIVE_ASSERT(count_to_be_removed_p == 0, "${%s@0}: ${%s@1} is zero.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(count_to_be_removed_p));
        FE_NEGATIVE_ASSERT(l_input_size == 0, "${%s@0}: ${%s@1} is zero.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(initializer_list_p.size()));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(input_iterator_begin_p == nullptr, "${%s@0}: ${%s@1} is nullptr.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(cstr_ptrc_p));
        FE_NEGATIVE_ASSERT(input_string_range_p._begin >= input_string_range_p._end, "${%s@0}: ${%s@1} must not be greater than ${%s@2}.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(input_string_range_p._begin), TO_STRING(input_string_range_p._end));
        FE_NEGATIVE_ASSERT(position_p > this->m_length, "${%s@0}: ${%s@1} must not be greater than ${%s@2}.", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_INVALID_SIZE), TO_STRING(position_p), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
...
#pragma warning(pop)
    ...
    {
        FE_NEGATIVE_ASSERT(dest_out_buffer_p == nullptr, "${%s@0}: dest_out_buffer_p is nullptr", TO_STRING(ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR));
        FE_NEGATIVE_ASSERT(count_p > this->m_length, "${%s@0}: ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), TO_STRING(count_p), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    {
        FE_NEGATIVE_ASSERT(position_p > this->m_length, "${%s@0}: ${%s@1} cannot be greater than ${%s@2}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), TO_STRING(position_p), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
    ...
    _FE_NODISCARD_ _FE_CONSTEXPR20_ std::optional<algorithm::string::range> find(const value_type* const string_p, const size_type position_p = 0) const noexcept
    {
        ...
        FE_NEGATIVE_ASSERT(position_p > this->m_length, "${%s@0}: position_p cannot be greater than ${%s@1}.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_ACCESS_VIOLATION), TO_STRING(this->m_length));
        FE_NEGATIVE_ASSERT(this->m_smart_string.get() == nullptr, "${%s@0}: ${%s@1} was nullptr.", TO_STRING(FE::ERROR_CODE::_FATAL_MEMORY_ERROR_1XX_NULLPTR), TO_STRING(this->m_smart_string.get()));
...
struct is_basic_string<FE::basic_string<T, Allocator, Traits>> : std::true_type {};


template <typename T, typename Allocator, typename Traits>
struct is_string_class<FE::basic_string<T, Allocator, Traits>> : std::true_type {};
