#ifndef _FE_FRAMEWORK_PAWN_BASE_HPP_
#define _FE_FRAMEWORK_PAWN_BASE_HPP_
/*
...
class pawn_base : public object_base
{
	REGISTER_FE_CLASS(pawn_base);
	FE_CLASS_HAS_A_BASE(object_base);

public:
	pawn_base() noexcept;
	virtual ~pawn_base() noexcept = 0;
