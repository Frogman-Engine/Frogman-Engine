...
{
    ::FE::framework::framework_base::get_engine().get_method_reflection().register_task< ::FE::c_style_task<void(void*), typename ::FE::function<void(void*)>::arguments_type> >("FHT Gen ::FrogmanEngine::Math::Vector3()", &::FE::framework::reflection::construct_object<::FrogmanEngine::Math::Vector3>); 
    ...
    ::FE::framework::framework_base::get_engine().get_method_reflection().register_task< ::FE::c_style_task<void(void*), typename ::FE::function<void(void*)>::arguments_type> >("FHT Gen ::FrogmanEngine::Utility::Timer()", &::FE::framework::reflection::construct_object<::FrogmanEngine::Utility::Timer>); 
}
