...
//
//	FE::pair<std::array<int, 10>::iterator, std::array<int, 10>::iterator> l_result = FE::algorithm::utility::exclusion_sort<FE::algorithm::utility::EXCLUSION_SORT_MODE::_PUSH_TO_RIGHT>(l_array.begin(), l_array.end(), l_value_to_exclude);
//
