...
struct is_primitive
{
	_FE_MAYBE_UNUSED_ static constexpr inline bool value = ((FE::is_boolean<T>::value == true) || (FE::is_char<T>::value == true) || (std::is_integral<T>::value == true) || (std::is_floating_point<T>::value == true) || (FE::is_c_style_constant_string<T>::value == true) || (std::is_pointer<T>::value == true) || (FE::is_nullptr<T>::value == true));
};
...
struct is_numeric
{
	_FE_MAYBE_UNUSED_ static constexpr inline bool value = (((std::is_integral<T>::value == true) && (FE::is_boolean<T>::value == false)) || (std::is_floating_point<T>::value == true));
};
...
struct is_trivial
{
	_FE_MAYBE_UNUSED_ static constexpr inline bool value = std::is_trivially_constructible<T>::value && std::is_trivially_destructible<T>::value;
};
...
{
	_FE_MAYBE_UNUSED_ static constexpr inline bool value = ((FE::is_trivial<T>::value == true) || (FE::is_reflectable<T>::value == true) || (FE::has_iterator<T>::value == true));
};
