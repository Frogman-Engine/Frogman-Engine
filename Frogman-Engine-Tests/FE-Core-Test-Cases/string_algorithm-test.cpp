...
TEST(FE_algorithm_string, search_first_char)
{
	char l_string[] = "Carrots contain carotene, antioxidants, etcetera.";

	auto l_result = ::FE::algorithm::string::search_first_char(l_string, 'c');

	EXPECT_EQ(l_result->_target_data, 'c');
	EXPECT_EQ(l_result->_target_data_location, 8);
}

TEST(FE_algorithm_string, search_last_char)
{
	char l_string[] = "Carrots contain carotene, antioxidants, etcetera.";

	auto l_result = ::FE::algorithm::string::search_last_char(l_string, 'c');
...
TEST(FE_algorithm_string, search_first_substring)
{
	char l_string[] = "the University of Utah";

	std::optional l_result = ::FE::algorithm::string::search_first_substring<var::character>(l_string, "Orange County");
	EXPECT_FALSE(l_result.has_value());

	l_result = ::FE::algorithm::string::search_first_substring<var::character>(l_string, "Utah");
...
TEST(FE_algorithm_string, search_last_substring)
{
	const char* l_string = "Jesus is the son of GOD";
	std::optional l_result = ::FE::algorithm::string::search_last_substring<var::character>(l_string, "son");
...
//#endif
	...
	l_result = ::FE::algorithm::string::search_last_substring<var::character>(l_string, "Action");
...
TEST(FE_algorithm_string, search_first_char_within_range)
{
	char l_string[] = "Carrots contain carotene, antioxidants, etcetera.";

	auto l_result = ::FE::algorithm::string::search_first_char_within_range(l_string, FE::algorithm::string::range{7, 15}, 'c');
...
TEST(FE_algorithm_string, search_last_char_within_range)
{
	char l_string[] = "Carrots contain carotene, antioxidants, etcetera.";

	auto l_result = ::FE::algorithm::string::search_last_char_within_range(l_string, FE::algorithm::string::range{41, 49}, 'c');
...
TEST(FE_algorithm_string, search_first_substring_within_range)
{
	...
	std::optional l_result = ::FE::algorithm::string::search_first_substring_within_range<var::character>(l_string, string::range{0, 17}, "Love never fails.");
	EXPECT_TRUE(l_result.has_value());

	l_result = ::FE::algorithm::string::search_first_substring_within_range<var::character>(l_string, string::range{0, 120}, "will");
...
TEST(FE_algorithm_string, search_last_substring_within_range)
{
	...
	std::optional l_result = ::FE::algorithm::string::search_last_substring_within_range<var::character>(l_string, string::range{0, 21}, "love");
	char l_substring[7] = "\0";
	...
	l_result = ::FE::algorithm::string::search_last_substring_within_range<var::character>(l_string, string::range{0, 13}, "9");
	EXPECT_FALSE(l_result.has_value());

	l_result = ::FE::algorithm::string::search_last_substring_within_range<var::character>(l_string, string::range{2, 13}, "i");
	EXPECT_TRUE(l_result.has_value());
